...
import { Checkboxes } from "../../../../../common/InputField/Form";
export const JobPaymentAdmin = () => {
  return (
    <>
          ...
          <div className="row g-xxl-4 g-xl-4 g-lg-4 g-md-4 g-sm-3 g-3 ">
            <div className="col-12">
              <div className="Job_Payment_Management_top_nav">
                <PageTopNav data="JobPaymentManagement" activeTabName="Admin" />
              </div>
            </div>
            <div className="col-12 ">
              <PageTopBtn />
  ...
  const ListApp = (props) => {
    return (
      <tr>
        ...
        <td>{props.PaymentReceived}</td>
        <td>{props.ExpenseAndEmployeePay}</td>
        ...
        >
          <thead>
            <tr>
              ...
              <th scope="col">Expense & Employee pay</th>
